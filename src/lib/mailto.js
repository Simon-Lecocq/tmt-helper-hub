...
export function mailtoNouvelleDemande({
  ...
  const body = [
    ...
    link,
    ``,
    `Si vous refusez, vous pouvez répondre à ce mail en indiquant la raison — elle sera transmise au demandeur.`,
    ``,
    `Cordialement,`,
...
export function mailtoAssignation({
  ...
  const body = [
    ...
    ``,
    `👉 Cliquez sur le lien ci-dessous pour accéder à la demande :`,
    link,
    ``,
    `Cordialement,`,
    `TMT Helper Hub — BearingPoint TMT 🔵`,
